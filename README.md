...
- Chapters
  ...
  - [3. WEB API](https://github.com/msg-CareerPaths/csharp-training/blob/main/chapters/300-web-rest-api.md)
    - [3.1. Create and test you first .net core Web API project](https://github.com/msg-CareerPaths/csharp-training/blob/main/chapters/301-create-web-api-project.md)   
  ...
  - [5. Testing in .NET](https://github.com/msg-CareerPaths/csharp-training/blob/main/chapters/500-unit-tests.md)
