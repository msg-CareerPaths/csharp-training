...
- Chapters
  ...
  - 1. WEB API
    ...
    - [1.3. Configuration in ASP.NET Core](https://github.com/msg-CareerPaths/csharp-training/blob/main/chapters/103-configurations.md)
    - [1.4. Local drive access](https://github.com/msg-CareerPaths/csharp-training/blob/main/chapters/103-local-drive-access.md)
    - [1.5. Logging](https://github.com/msg-CareerPaths/csharp-training/blob/main/chapters/104-logging.md)
    - [1.6. Exception Handling](https://github.com/msg-CareerPaths/csharp-training/blob/main/chapters/105-exception-handling.md)
  ...
  * [3. Create GUI](https://github.com/msg-CareerPaths/csharp-training/blob/main/chapters/300-gui.md)
    * [3.1. Using Angular vs. React vs. Vue](https://github.com/msg-CareerPaths/csharp-training/blob/main/chapters/301-using-angular-vs-react-vs-vue.md)
